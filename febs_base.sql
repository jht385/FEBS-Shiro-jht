...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('FEBS_Scheduler', 'WQ-20160213ZATU1572706588393', '1572706704082', '15000');
...
CREATE TABLE `t_dict` (
  ...
  `ex1` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '扩展字段1',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_generator_config` (
  ...
  `html_root` varchar(100) DEFAULT NULL COMMENT 'html生成根目录',
  `js_root` varchar(100) DEFAULT NULL COMMENT 'js生成根目录',
  `css_root` varchar(100) DEFAULT NULL,
...
CREATE TABLE `t_log` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1069 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志表';
...
CREATE TABLE `t_login_log` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='登录日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'MrBird', 'cb62ad1497597283961545d608f80241', '1', 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2019-10-26 14:04:20', '2019-11-02 21:44:25', '0', '1', 'black', 'cnrhVkzwxjPwAaCfPbdc.png', '我是帅比作者。');
