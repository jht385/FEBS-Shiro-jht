<link rel="stylesheet" th:href="@{febs/css/${module}/${className?uncap_first}/${className?uncap_first}Add.css}" media="all">
...
<script th:src="@{febs/js/${module}/${className?uncap_first}/${className?uncap_first}Add.js}"></script>