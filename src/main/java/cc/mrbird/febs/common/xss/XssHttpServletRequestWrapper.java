...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
	...
	/**
	 * 覆盖 getParameter方法，将参数名和参数值都做xss过滤 如果需要获得原始的值，则通过
	 * super.getParameterValues(name)来获取 getParameterNames,getParameterValues和
	 * getParameterMap也可能需要覆盖
	 */
	@Override
	...
	/**
	 * 覆盖getHeader方法，将参数名和参数值都做 xss过滤 如果需要获得原始的值，则通过super.getHeaders(name)来获取
